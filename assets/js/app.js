...
function trabajando(action){
    if(action==null){
        var t = "<div class='modal-dialog' style='display:none;background-color: white;position: absolute; width:96%;margin-left:2%;z-index:1000000' id='trabajando_div'><center><img src='img/procesando.gif' ><br><br><h3>Trabajando... Espera</h3></center></div>";
        $('#content').append(t);
    } else if (action==1){
        $("#trabajando_div").css('display','block');
    } else {
        $("#trabajando_div").css('display','none');
    }
}
