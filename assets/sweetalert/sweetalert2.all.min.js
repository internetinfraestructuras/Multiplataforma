!function (e, t) {
    ...
    var t = "SweetAlert2:", f = function (e) {
        ...
        b = g(["success", "warning", "info", "question", "error"]), y = {previousBodyPadding: null},
        v = function (e, t) {
        ...
        J = function (e) {
            ...
            if (t && (t.parentNode.removeChild(t), N([document.documentElement, document.body], [I["no-backdrop"], I["toast-shown"], I["has-column"]])), !j()) {
                ...
                var o, r = x(), i = P(), a = W(i, I.input), c = W(i, I.file),
                    s = i.querySelector(".".concat(I.range, " input")),
                    u = i.querySelector(".".concat(I.range, " output")), l = W(i, I.select),
                    d = i.querySelector(".".concat(I.checkbox, " input")), p = W(i, I.textarea);
                ...
                var f = function (e) {
                    qe.isVisible() && o !== e.target.value && qe.resetValidationError(), o = e.target.value
                };
                return a.oninput = f, c.onchange = f, l.onchange = f, d.onchange = f, p.oninput = f, s.oninput = function (e) {
                    f(e), u.value = s.value
            ...
            if (e.type) if (-1 !== Object.keys(b).indexOf(e.type)) {
            ...
            var i = E(), a = parseInt(null === r.currentProgressStep ? qe.getQueueStep() : r.currentProgressStep, 10);
    ...
    var le = {
        ...
        fe = function (e) {
            ...
            for (var t in e) fe(t) || m('Unknown parameter "'.concat(t, '"')), e.toast && -1 !== pe.indexOf(t) && m('The parameter "'.concat(t, '" is incompatible with toasts')), me(t) && h('The parameter "'.concat(t, '" is deprecated and will be removed in the next major release.'))
        },
    ...
    var ye = [], ve = function () {
            ...
            getButtonsWrapper: function () {
                return h("swal.getButtonsWrapper() is deprecated and will be removed in the next major release, use swal.getActions() instead"), k(I.actions)
            },
            getActions: Z,
            getConfirmButton: O,
            getCancelButton: F,
            ...
            queue: function (e) {
                ...
                return new Promise(function (r) {
                    !function t(n, o) {
                        n < ye.length ? (document.body.setAttribute("data-swal2-queue-step", n), i(ye[n]).then(function (e) {
                            void 0 !== e.value ? (c.push(e.value), t(n + 1, o)) : (a(), r({dismiss: e.dismiss}))
                        })) : (a(), r({value: c}))
                    }(0)
                })
            },
    ...
    function Ae() {
        var e = xe.innerParams.get(this), t = xe.domCache.get(this);
    ...
    var Se = function (e) {
        var t = C(), n = x();
        null !== e.onBeforeOpen && "function" == typeof e.onBeforeOpen && e.onBeforeOpen(n), e.animation ? (D(n, I.show), D(t, I.fade), N(n, I.hide)) : N(n, I.fade), z(n), t.style.overflowY = "hidden", G && !v(n, I.noanimation) ? n.addEventListener(G, function e() {
            n.removeEventListener(G, e), t.style.overflowY = "auto"
        }) : t.style.overflowY = "auto", D([document.documentElement, document.body, t], I.shown), e.heightAuto && e.backdrop && !e.toast && D([document.documentElement, document.body], I["height-auto"]), L() && (ae(), function () {
    ...
    var Ee, Oe = Object.freeze({
        hideLoading: Ae, disableLoading: Ae, getInput: function (e) {
            var t = xe.innerParams.get(this), n = xe.domCache.get(this);
            ...
            !function (t) {
                ...
                var n = x(), o = "string" == typeof t.target ? document.querySelector(t.target) : t.target;
            ...
            return new Promise(function (t, n) {
                var o = function (e) {
                    q.closePopup(T.onClose, T.onAfterClose), T.useRejections ? t(e) : t({value: e})
                }, s = function (e) {
                    q.closePopup(T.onClose, T.onAfterClose), T.useRejections ? n(e) : t({dismiss: e})
                }, u = function (e) {
                ...
                for (var l = function (t) {
                    ...
                    switch (e.type) {
                        case"click":
                            if (r && q.isVisible()) if (L.disableButtons(), T.input) {
                                var a = function () {
                                    var e = L.getInput();
                                    if (!e) return null;
                                    switch (T.input) {
                            ...
                            } else l(!0); else i && q.isVisible() && (L.disableButtons(), s(q.DismissReason.cancel))
                    }
                ...
                ce.keydownHandlerAdded && (ce.keydownTarget.removeEventListener("keydown", ce.keydownHandler, {capture: ce.keydownListenerCapture}), ce.keydownHandlerAdded = !1), T.toast || (ce.keydownHandler = function (e) {
                    return function (e, t) {
                        if (t.stopKeydownPropagation && e.stopPropagation(), "Enter" !== e.key || e.isComposing) if ("Tab" === e.key) {
                            for (var n = e.target, o = $(t.focusCancel), r = -1, i = 0; i < o.length; i++) if (n === o[i]) {
                                r = i;
                                break
                            }
                            e.shiftKey ? c(r, -1) : c(r, 1), e.stopPropagation(), e.preventDefault()
                        } else -1 !== ["ArrowLeft", "ArrowRight", "ArrowUp", "ArrowDown", "Left", "Right", "Up", "Down"].indexOf(e.key) ? document.activeElement === j.confirmButton && K(j.cancelButton) ? j.cancelButton.focus() : document.activeElement === j.cancelButton && K(j.confirmButton) && j.confirmButton.focus() : "Escape" !== e.key && "Esc" !== e.key || !0 !== M(t.allowEscapeKey) || s(q.DismissReason.esc); else if (e.target && L.getInput() && e.target.outerHTML === L.getInput().outerHTML) {
                ...
                if ("select" === T.input || "radio" === T.input) {
                    ...
                    H(T.inputOptions) ? (q.showLoading(), T.inputOptions.then(function (e) {
                        L.hideLoading(), O(e)
                ...
                } else -1 !== ["text", "email", "number", "tel", "textarea"].indexOf(T.input) && H(T.inputValue) && (q.showLoading(), U(d), T.inputValue.then(function (e) {
                    d.value = "number" === T.input ? parseFloat(e) || 0 : e + "", z(d), d.focus(), L.hideLoading()
                }).catch(function (e) {
                    R("Error in inputValue promise: " + e), d.value = "", z(d), d.focus(), L.hideLoading()
                }));
    ...
    }, i(Le.prototype, Oe), i(Le, we), Object.keys(Oe).forEach(function (t) {
        Le[t] = function () {
            var e;
            if (Ee) return (e = Ee)[t].apply(e, arguments)
        }
    }), Le.DismissReason = e, Le.noop = function () {
    }, Le.version = "7.26.28";
    var Te, je, qe = ue((Te = Le, je = function (e) {
        ...
        return a(t, Te), r(t, [{
            ...
            key: "setDefaults", value: function (t) {
                ...
                he(t), Object.keys(t).forEach(function (e) {
