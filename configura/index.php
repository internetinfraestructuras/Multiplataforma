...
if (isset($_POST['guardando'])) {
    ...
    foreach ($_POST as $clave => $valor) {
        ...
        if ($c == 'InternetGatewayDevice.LANDevice.1.LANHostConfigManagement.DHCPServerEnable') {
            if (trim($v) == 'on') $v = 'true'; else if (trim($v) == 'off') $v = 'false'; else if (trim($v) == '1') $v = 'true'; else if (trim($v) == '0') $v = 'false';
        }
...
<head>
    ...
    <!-- WEB FONTS -->
    <link href="http://fonts.googleapis.com/css?family=Open+Sans:300,400,700,800&amp;subset=latin,latin-ext,cyrillic,cyrillic-ext"
...
<!--    <link href="http://5.40.80.11/assets/css/color_scheme/green.css" rel="stylesheet" type="text/css" id="color_scheme"/>-->

    <!-- JQGRID TABLE -->
    <link href="ui.jqgrid.css" rel="stylesheet" type="text/css"/>
    <link href="layout-jqgrid.css" rel="stylesheet" type="text/css"/>
    <!--    light   box-->
...
<!--    <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.2.0/css/all.css" integrity="sha384-hWVjflwFxL6sNzntih27bfxkr27PmbbK/iSvJ+a4+0owXq79v+lsFkW54bOGbiDQ" crossorigin="anonymous">-->
    ...
    <style>
        body {
            background: url(http://5.40.80.11/img/fondo2.jpg) no-repeat center center fixed;
            ...
            <div class="panel panel-default">
                <div class="panel-heading panel-heading-transparent" style="height:50px">
                    ...
                    <?php if (isset($_SESSION['sesion_iniciada']) && $_SESSION['sesion_iniciada'] != '') { ?>
                        <img src="http://5.40.80.11/img/Loading_2.gif" style="height: 40px;margin-top:-10px; display:none" id="formanima1">
                ...
                <div class="panel-body">
                    <?php if (isset($_SESSION['sesion_iniciada']) && $_SESSION['sesion_iniciada'] != '') {
                        echo '<form id="form" enctype="multipart/form-data" action="index.php" method="post">
...
//                        }
                        ...
                        $ch = curl_init($url);
                        include("lista_parametros_refresh_wifi.php");
                        $cfg = array();
                        foreach ($aItems as $clave) {
                        ...
                        $json = json_decode($result, true);
                        sleep(3);
                         include("lista_parametros_consultar_wifi.php");
...
<!--                                        </option>-->
                            ...
                            <div class="col-lg-3 col-xs-12">
                                <div class="col-xs-12">
                                    ...
                                    <label style="margin-top:-8px" class="checkbox">
                                        <input type="hidden" value="0" id="dhcp"
                    ...
                    <?php } else { ?>
                        ...
                        <div class="col-lg-5 text-center">
                            <!-- login form -->
                            <form action="index.php" id="form1" method="post" enctype="multipart/form-data" class="">
                            ...
                            <center>
                            <img src="http://5.40.80.11/img/Loading_2.gif" id="formanima2" style="width:40px; display:none">
                            </center>
                            <!-- /login form -->
                        </div>
                        <div class="col-lg-3 text-center">
                            <br>
                            <img src="http://5.40.80.11/img/ont1.PNG" id="ayuda" style="max-width: 300px;"><br><br>
                        </div>
                    <?php } ?>
                </div>
            </div>
...
<div class="modal fade modal-lg" id="encontradas" role="basic" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content" id="encontradas_content" style="padding:5%">
            <center>
                <img src="http://5.40.80.11/img/procesando.gif" id="img_procesando">
                <br><br>
...
<!-- JAVASCRIPT FILES -->
<script type="text/javascript">var plugin_path = '/';</script>
