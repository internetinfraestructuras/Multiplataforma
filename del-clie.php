                ...
                $.ajax({
                    ...
                    success: function(jqgrid_data) {
                        ...
                        jQuery("#jqgrid").jqGrid({
                            ...
                            datatype : "local",
                            height : '400',
                            colNames : ['Borrar','Dni','Nombre','Apellidos','Dirección','Localdidad','Provincia',
                        ...
                        rowNum : 10,
                            ...
                            gridComplete: function(){
                                ...
                                for(var i=0;i < ids.length;i++){
                                    var cl = ids[i];
                                    de = "<button class='btn btn-xs btn-default btn-quick' title='Borrar' onclick=\"jQuery('#jqgrid').delRowData('"+cl+"','cli');\"><i class='fa fa-trash'></i></button>";
                                    jQuery("#jqgrid").jqGrid('setRowData',ids[i],{act:de});
                                }
                            },
