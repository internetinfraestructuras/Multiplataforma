                ...
                $.ajax({
                    ...
                    success: function(jqgrid_data) {
                        ...
                        jQuery("#jqgrid").jqGrid({
                            ...
                            datatype : "local",
                            height : '400',
                            colNames : ['Dni','Nombre','Apellidos','Email','Teléfono','Nivel','Notas','Fecha Alta','Ult. Modif', 'Ult. Acceso','Activo','Usuario'],
                            colModel : [
                                ...
                                { name : 'modi', index : 'modi', sortable : false, editable : false },
                                { name : 'acceso', index : 'acceso', sortable : false, editable : false },
                                { name : 'activo', index : 'activo', sortable : false, editable : true },
                        ...
                        rowNum : 10,
                            ...
                            gridComplete: function(){
                                ...
                                //     de = "<button class='btn btn-xs btn-default btn-quick' title='Borrar' onclick=\"jQuery('#jqgrid').delRowData('"+cl+"','user');\"><i class='fa fa-trash'></i></button>";
