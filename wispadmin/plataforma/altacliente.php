...
<div id="container">
	...
	<div id="main">
		<div id="content">
					...
					<tr>
					<td width="20%">Umbral Alerta (€ ó Mins. -según proceda-): </td>
					...
					<td width="30%" align="center">
						...
						<input type="radio" name="form_opcionip" value="estatica"  onclick="showMe()">&nbsp;&nbsp;Direccion Estática
					...
					<input type="submit" value="Añadir usuario" style=" width:90;height:90; background-image:url(./images/bg_button.gif)"> 	&nbsp;&nbsp;&nbsp;
