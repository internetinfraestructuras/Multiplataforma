...
$nombrecallcenter=$_POST['form_nombre'];
...
<div id="container">
	...
	<div id="main">
		<div id="content">
					...
					$var = " /usr/sendEmail/sendEmail -f plataforma.prepago@gmail.com -t paco.perez@gruporeq.com -s smtp.gmail.com -u Plataforma REQ: Solicitud Creacion de troncal   -v -o tls=yes -xu plataforma.prepago -xp gruporeq1430 -m SuperUsuario: $usuario, Cliente: $form_cif , Callcenter: $id_centralita,$nombrecallcenter Protocolo: $protocolo, Codecs: $codecs, DID:$did. HAY QUE CREAR LA TRONCAL Y EL DPLN EN TUKU01";
					//echo $var;
					exec($var);
					...
					<form type="POST" action="solicitar_troncal.php">
