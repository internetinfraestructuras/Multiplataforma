...
<SCRIPT LANGUAGE="Javascript">
	...
	function confirmacion_total(masteruser,cif,importe)
	{

		opener.location=('confirmar_eliminacion_cliente.php?super='+masteruser+'&cif='+cif); 
		self.close();
...
<body>
					...
					<?php echo "<p>¿Confirma que desea eliminar el cliente $cif_cliente?</p>";
					...
					<input type="button" value="Eliminar" onclick="confirmacion_total('<?php echo $superusu;?>','<?php echo $cif_cliente;?>','<?php echo $importe;?>')" style=" width:60;height:20; background-image:url(./images/bg_button.gif)"> 
