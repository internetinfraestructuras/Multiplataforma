...
//------------------------------------------------------------------------------------------------------------------					
					...
					if($usuario!=$superuser_propietario_legitimo)
					{
						...
						$seccion= "confirmacion_a_cero.php";
					...
					$sel = "insert into historicorecargas(cif_user,calldate,importe,acumulado,neto) VALUES ('$cif','$fecha','0','$saldo_recarga','$neto')";
					$query = mysql_query($sel) or die(mysql_error());						
											
						
						
					//añadimos el saldo al cliente			
					
					$sel = "update usuarios set saldo='0' where cif='$cif'";
					...
					*/
					...
					<h4 class="title">Reseteo efectuado <?php echo $form_cif;?></h4>	
					<p align="center">&nbsp;</p>
					<div align="center">
					
					
					Reseteo efectuado con éxito.<br><br><br>
