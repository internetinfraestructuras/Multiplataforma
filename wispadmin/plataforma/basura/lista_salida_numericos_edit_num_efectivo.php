...
<div id="container">
	...
	<div id="main">
		<div id="content">
					...
					$sel="update lista_numeros_callcenter set numero='$nuevo_numerico' where usuario_troncal='$troncal' and posicion='$posicion'";
					...
					<h4 class="title">Modificando numérico</h4>	
					<p align="center">&nbsp;</p>
					<div align="center">
