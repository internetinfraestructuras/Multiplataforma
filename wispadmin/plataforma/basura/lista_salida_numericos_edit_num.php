...
<div id="container">
	...
	<div id="main">
		<div id="content">
					...
					$sel = "select * from lista_numeros_callcenter where usuario_troncal= ( select usuario_troncal from troncales where usuario_troncal='$troncal' and id_centralita='$callcenter') and posicion='$posicion'";

						$query = mysql_query($sel) or die(mysql_error());
						
					while ($row = mysql_fetch_assoc($query)) 
					{
						$numero_salida=$row['numero'];
					...
					<h4 class="title">Editando <?php echo $numero_salida;?></h4>	
					<p align="center">&nbsp;</p>
					<div align="center">
					...
					<form action="lista_salida_numericos_edit_num_efectivo.php" method="post" name="form_cliente" width="30%">
					<div align="center">
					...
					<table width="80%">
					<caption>Datos Numérico</caption>
					<tr>
					<td width="20%">Posición: </td>
					<input type="hidden" align="center" size="53" name="form_posicion" readonly="yes" value="<?php echo $posicion;?>">
					<td width="30%" align="center"><?php echo $posicion;?></td>
					</tr>
					<tr>
