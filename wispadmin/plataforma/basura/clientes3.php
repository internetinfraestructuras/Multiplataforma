...
<a href=\"clientes.php?orden=cif\">CIF</a></td><td><a href=\"clientes.php?orden=nombre\">
Nombre</a></td><td><a href=\"clientes.php?orden=email\">Email</a></td><td>Call-Centers</td>
<td><a href=\"clientes.php?orden=euros\">Eur/Mins</a></td><td>Recargas</td></thead><tbody>";	
					...
					else if($ordenacion=="email"){
					  $sel = "select * from usuarios where cif_super='$usu' order by email";		 						
					}
