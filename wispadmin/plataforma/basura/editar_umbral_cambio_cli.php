...
<div id="container">
	...
	<div id="main">
		<div id="content">
					...
					while ($row = mysql_fetch_assoc($query)) 
					{
						$umbral_actual=$row['umbral_cambio_cli'];
					}
					...
					<h4 class="title">Editando umbral de rotación para <?php echo $troncal ?></h4>	
					<p align="center">&nbsp;</p>
					<div align="center">
					...
					<form action="editar_umbral_cambio_cli_efectivo.php" method="post" name="form_cliente" width="30%">
					<div align="center">
					...
					<table width="80%">
					<caption>Umbral de rotación</caption>
					<tr>
					<td width="20%">Valor (siempre mayor que 0): </td>
					<td width="30%" align="center"><input type="text" STYLE="text-align:center" size="10" onkeypress="return validar_texto(event)" name="form_valor_umbral" value="<?php echo $umbral_actual;?>"></td>
					</tr>
					...
					<p align="center">&nbsp;</p>
					<div align="center">
					<input type="button" value="Volver a listado"  onClick="location.href = 'lista_salida_numericos_troncal.php?callcenter=<?php echo $callcenter; ?>&usuario_troncal=<?php echo $troncal; ?>'"  style=" width:90;height:90; background-image:url(./images/bg_button.gif)"> &nbsp;&nbsp;&nbsp; 					
