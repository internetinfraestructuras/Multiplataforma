...
<SCRIPT LANGUAGE="Javascript">
	...
	function confirmacion_total(troncal,prefijo)
	{
		...
		opener.location=('confirmar_eliminacion_todas_tarifas.php?troncal='+troncal); 
		self.close();
...
<body>
					...
					<?php echo "<p>¿Confirma que desea eliminar todas las tarifas asociadas a la troncal <b>$troncal</b> ?</p>";
