...
<div id="container">
	...
	<div id="main">
		<div id="content">
					...
					<h4 class="title"><?php echo "Numéricos para Troncal : $troncal (".nombre_centralita($callcenter).")";?></h4>			
			        <div align="center"> 
					<?php
					...
					if($usuario!=$superuser_propietario_legitimo)
					{
						...
						$web_violacion="numericos_troncal.php";
					...
					echo "<caption>Numéricos de entrada </caption><thead><tr><td>Numérico</td><td>Descripción</td></thead><tbody>";
					...
					$sel = "select * from numericos where usuario_troncal= ( select usuario_troncal from troncales where usuario_troncal='$troncal' and id_centralita='$callcenter')";
					$query = mysql_query($sel) or die(mysql_error());
					...
					while ($row = mysql_fetch_assoc($query)) 
					{
						...
						if($colorfila%2==0)
						{
							echo "<tr><td>".$row['numero']."</td><td>".$row['descripcion']."</td></tr>";
					    }
						else
						{							
							echo "<tr class=\"odd\"><td>".$row['numero']."</td><td>".$row['descripcion']."</td></tr>";
						}	
						$colorfila++;
					}
					...
					<form action="solicitud_numerico.php" method="post" name="form_centralita" width="30%">
					<div align="center">
					...
					<input type="submit" value="Solicitar nuevo número" style=" width:90;height:90; background-image:url(./images/bg_button.gif)"> 	&nbsp;&nbsp;&nbsp;
					</div>
					</form>
