	...
	<div id="main">
		<div id="content">
					...
					<?php
						...
						$fechadesde = $doblescomillas.$fechadesde.$doblescomillas;
					...
					echo "<caption>Historico de Recargas : $usuario</caption><thead><tr><td>Fecha y Hora</td><td>Importe</td><td>Acumulado</td><td>Neto</td></thead><tbody>";
					$colorfila=0;	
					
					//conectamos a  MYSQL
						
					$sel = "select * from gestioncdr.historicorecargassuperusuario where cif_super='$cif' and calldate between '$mesinicio 00:00:00' and '$mesfin 23:59:59'";
					...
					$sel = "select * from historicorecargassuperusuario where cif_super='$cif' and calldate between '$mesinicio 00:00:00' and '$mesfin 23:59:59'";
					$query = mysql_query($sel) or die(mysql_error());
					...
					<form>
					<input type="button" value="Volver a Historico"  onClick="location.href = 'historicorecargas.php'" style=" width:90;height:90; background-image:url(./images/bg_button.gif)"> 
					</form>
					</div>
