...
$cif_superuser=cif_superusuario($usuario);
...
<div id="container">
	...
	<div id="main">
		<div id="content">
					...
					<h4 class="title">Alta Tarifa Troncal: <?php echo $troncal;?></h4>	
					<p align="center">&nbsp;</p>
					<div align="center">
					...
					<form action="alta_tarifa_cliente_confirmacion_lista.php" method="post" name="form_cliente" onSubmit=pasarvector()>
					<input name="arv" type="hidden">
					<input name="form_porcentajebeneficio" type="hidden" value='0'>
					...
					<input type="hidden" align="center" size="53" name="form_superuser" value="<?php echo $cif_superuser;?>">
					...
					echo "<div align='center'>Despliegue grupo y seleccione destino por prefijos, posteriormente tendrá la posibilidad de modificar los costes por minuto.</div><br><br>";
					...
					{									
						...
						echo "<UL  class='$grupsinespacios'> <INPUT TYPE=CHECKBOX NAME='$nbrgrupsinespacios' onClick=\"marcar_grupo(this.form,'$grupsinespacios',this.checked) \"/>  $grupsinespacios";
					...
					$querye = mysql_query($sel2) or die(mysql_error());
						...
						echo "<thead><tr><td>Check</td><td>Grupo</td><td>Prefijo</td><td>Descripcion</td><td>Coste(€/min)</td></thead><tbody>";
							...
							while ($rowe = mysql_fetch_assoc($querye)) 
							{
								...
								{							
								echo "<li class='$grupsinespacios' id='$prefix' ><tr class=\"odd\"><td><INPUT TYPE=CHECKBOX NAME='$grupsinespacios'  class='$grupsinespacios' onClick=\"li_borrar_prefijo_vector('$prefix',this.checked)\"></td><td>".$grupsinespacios."</td><td>".$rowe['prefijo']."</td><td>".$rowe['descripcion']."</td><td>".$rowe['coste']."</td></tr>";
								}	
								$colorfila++;
							}
							$colorfila=0;
