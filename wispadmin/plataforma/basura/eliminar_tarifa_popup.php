...
<SCRIPT LANGUAGE="Javascript">
	...
	function confirmacion_total(troncal,prefijo)
	{

		opener.location=('confirmar_eliminacion_tarifa.php?troncal='+troncal+'&prefijo='+prefijo); 
		self.close();
		
		//NOS KEDAMOS POR AKI, HABRIA QUE HACER LAS VENTANAS DE CONFIRMACION_dE RECARGA, HACERLA EN LA BD Y RECARGA_CANCELADA
	}

	function cancelacion_total(troncal)
	{

		opener.location=('eliminacion_tarifa_cancelada.php?troncal='+troncal); 
		self.close();
	}
</SCRIPT>
...
<body>
					...
					<?php echo "<p>¿Confirma que desea eliminar la tarifa <b>$descripcion</b> asociada al call center <b>$nombre_centralita</b> ?</p>";
					...
					<input type="button" value="Eliminar" onclick="confirmacion_total('<?php echo $troncal;?>','<?php echo $prefijo;?>')" style=" width:60;height:20; background-image:url(./images/bg_button.gif)"> 
					<input type="button" value="Cancelar" onclick="cancelacion_total('<?php echo $troncal;?>')" style=" width:60;height:20; background-image:url(./images/bg_button.gif)"> 
