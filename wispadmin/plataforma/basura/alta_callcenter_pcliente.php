...
<div id="container">
	...
	<div id="main">
		<div id="content">
					...
					<h4 class="title">Alta Call Center</h4>	
					<p align="center">&nbsp;</p>
					<div align="center">
					
					</div>
					
					<form action="alta_callcenter_efectivo_cliente.php" method="post" name="form_cliente" width="30%">
					<div align="center">
					...
					<caption> Datos CallCenter para cliente: <?php echo $cif_cliente;?></caption>
					<tr>
