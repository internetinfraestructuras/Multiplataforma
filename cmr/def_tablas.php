...
$t_usuarios=array('dni','nombre','apellidos','email','telefono','nivel','clave','notas','fecha_alta','ultima_modificacion','ultimo_acceso','activo');

$t_revendedores=array('hash','dni','nombre','apellidos','empresa','direccion','localidad','provincia','region', 'cp','tel1','tel2','email','web','logo','notas','hash');
...
$t_aprovisionados=array('id_cliente','id_usuario','fecha','lat','lon','internet','iptv','voip','modelo_ont',
    ...
    'ppoe_password','id_en_olt','c','t','p','serial','caja','puerto','id_internet','id_voip','id_iptv', 'cabecera','num_pon','id_vpn');
