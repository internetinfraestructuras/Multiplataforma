                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-sm-6 col-md-6 col-xs-12">
                            ...
                            <input type="text" name="nuevo_nom" id="nuevo_nom" class="form-control" style="width:39%; display:inline" placeholder="Nombre">
                            <input type="text" name="nuevo_ape" id="nuevo_ape" class="form-control" style="width:59%; display:inline" placeholder="Apellidos">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2 col-sm-3 col-md-2 col-xs-6">
                            ...
                            <select name="gestionada" id="gestionada"
                                ...
                                <?php if(intval($_COOKIE['gestionada'])==1){
                        ...
                        <div class="col-lg-2 col-sm-3 col-md-2 col-xs-6">
                            ...
                            <select name="tipoip" id="tipoip" onchange="tipoip(this.value)"
                                    class="form-control pointer required" <?php if(intval($_COOKIE['gestionada'])==0) echo 'disabled="disabled"';?> >
                        ...
                        <div class="col-lg-2 col-sm-3 col-md-2 col-xs-6" id="pppoes_ocultar"
                             style="display: <?php echo $_COOKIE['asignada']==1? 'block':'none'; ?>">
                        ...
                        <div class="col-lg-2 col-sm-3 col-md-2 col-xs-6" id="velup_ocultar"
                             style="display: <?php echo $_COOKIE['asignada']==1? 'none':'block'; ?>">
                            <label>Subida</label>
                        ...
                        <div class="col-lg-2 col-sm-3 col-md-2 col-xs-6" id="veldw_ocultar"
                             style="display: <?php echo $_COOKIE['asignada']==1? 'none':'block'; ?>">
                        <label>Bajada</label>
...
<!--                        </div>-->
                        ...
                        <div class="col-lg-2 col-xs-12">
                            <label class="visible-xs" style="margin-top:20px;">SSID Wifi<i class="fa fa-question-circle"></i></label>
                        ...
                        <div class="col-lg-2 col-xs-12">
                            <label class="visible-xs" style="margin-top:20px;">Clave Wifi<i class="fa fa-question-circle"></i></label>
            ...
            <div class="panel panel-default" id="panel_voip" style="display:none">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-xs-12">
                            <label>Número PON ONT</label>
                            <input type="text" name="vo-serial_pon" id="vo-serial_pon" class="required form-control masked" data-format="****************" data-placeholder="_" placeholder="16 Caracteres (puede buscar auto o usar lector)">
                        </div>
...
<!--                        </div>-->
                        ...
                        <div class="col-lg-3 col-xs-12">
                            <label class="visible-xs" style="margin-top:20px;">Número de Serie ONT</label>
                            <label class="hidden-xs">Número de Serie ONT</label>
                            <input type="text" name="vo-serial" id="vo-serial" class="required form-control" placeholder="010118IPTV12123456">
                        </div>
            ...
            <div class="panel panel-default" id="panel_iptv" style="display:none">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-xs-12">
                            <label>Número PON ONT</label>
                            <input type="text" name="tv-serial_pon" id="tv-serial_pon" class="required form-control masked" data-format="****************" data-placeholder="_" placeholder="16 Caracteres (puede buscar auto o usar lector)">
                        </div>
...
<!--                        </div>-->
                        ...
                        <div class="col-lg-3 col-xs-12">
                            <label class="visible-xs" style="margin-top:20px;">Número de Serie ONT</label>
                            <label class="hidden-xs">Número de Serie ONT</label>
                            <input type="text" name="tv-serial" id="tv-serial" class="required form-control" placeholder="010118IPTV12123456">
                        </div>
     ...
     //       $("#resultado_modal").hide(1000);
        ...
        function btnautofind(){
            ...
            if (olt == '') {
                ...
                setTimeout(function(){encontradas=false;no_se_encuentra_nada(); }, 60000);
