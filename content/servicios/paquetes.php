            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-4 col-md-3 col-xs-12">
                    ...
                    <select id="internet" multiple="multiple" name="paquete[internet]" style="height:260px" class="form-control" onchange="calcularPVP(this)">
                        ...
                        $cabeceras = $util->selectWhere('SERVICIOS', array('id', 'NOMBRE_COMERCIAL','PRECIO_PROVEEDOR'), 'ID_EMPRESA='.$_SESSION['REVENDEDOR'].' AND ID_SERVICIO_TIPO=1', 'NOMBRE_COMERCIAL');
                        ...
                        while ($row = mysqli_fetch_array($cabeceras)) {
                            ...
                            echo "<option data-coste='".$row['PRECIO_PROVEEDOR']."' value='" . $row['id'] . "'>" . $row['NOMBRE_COMERCIAL']. "</option>";
                        }
                        ?>
                    </select>
                ...
                <div class="col-lg-3 col-sm-4 col-md-3 col-xs-12">
                    ...
                    <select id="fijo" multiple="multiple" style="height:260px" class="form-control" name="paquete[fijo]" onchange="calcularPVP(this)" >
                        <?php
                        // carga el listado de cabeceras en el select
                        $cabeceras = $util->selectWhere('SERVICIOS', array('id', 'NOMBRE_COMERCIAL','PRECIO_PROVEEDOR'), 'ID_EMPRESA='.$_SESSION['REVENDEDOR'].' AND ID_SERVICIO_TIPO=2', 'NOMBRE_COMERCIAL');
                ...
                <div class="col-lg-3 col-sm-4 col-md-3 col-xs-12">
                    ...
                    <select id="movil"  multiple="multiple" style="height:260px" class="form-control" name="paquete[movil][]" onchange="calcularPVP(this)">
                        <?php
                        // carga el listado de cabeceras en el select
                        $cabeceras = $util->selectWhere('SERVICIOS', array('id', 'NOMBRE_COMERCIAL','PRECIO_PROVEEDOR'), 'ID_EMPRESA='.$_SESSION['REVENDEDOR'].' AND ID_SERVICIO_TIPO=3', 'NOMBRE_COMERCIAL');
                ...
                <div class="col-lg-3 col-sm-4 col-md-3 col-xs-12">
                    ...
                    <select id="tv" multiple="multiple"  style="height:260px" class="form-control" name="paquete[tv]" onchange="calcularPVP(this)">
                        <?php
                        // carga el listado de cabeceras en el select
                        $cabeceras = $util->selectWhere('SERVICIOS', array('id', 'NOMBRE_COMERCIAL','PRECIO_PROVEEDOR'), 'ID_EMPRESA='.$_SESSION['REVENDEDOR'].' AND ID_SERVICIO_TIPO=4', 'NOMBRE_COMERCIAL');
