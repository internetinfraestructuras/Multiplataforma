    ...
    <section id="middle">
        ...
        <header id="page-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Nuevo Grupo de Recarga</li>
            </ol>
        </header>
        <!-- /page title -->
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading panel-heading-transparent">
                            <strong>Nuevo Grupo de Recarga</strong>
                        </div>
                        ...
                        <div class="panel-body">
                            ...
                            <form  action="crear-grupoderecarga.php" method="post"
                                ...
                                <fieldset>
                                    ...
                                    <input type="hidden" name="action" value="gruporecarga"/>
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3 col-sm-3">
                                                ...
                                                <input type="text" name="gruporecarga[nombre]" value=""
                                                       class="form-control" required>
                                            </div>
                                            <div class="col-md-3 col-sm-3">
                                                <label>Importe: </label>
                                                <input type="text" name="gruporecarga[importe]" value=""
                                                       class="form-control " required>
                                            </div>
                                            <div class="col-md-3 col-sm-3">
                                                <label>Acumulable</label>
                                                <select  name="gruporecarga[acumulable]" selected="NO" class="form-control ">
                                            ...
                                            <div class="col-md-3 col-sm-3">
                                                <label>Color</label>
                                                <input id="background-color" name="gruporecarga[background-color]" type="color" class="form-control "/>
                                            </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body" id="listado">
							...
							<span class="title elipsis">
								<strong>LISTADO DE GRUPOS DE RECARGA</strong> <!-- panel title -->
							</span>
                                ...
                                <div class="panel-body">
                                    ...
                                    <table id="example2" class="table table-bordered table-hover">
                                        ...
                                        <?php
                                            $grupos = $tel->getGruposRecargaFull($_SESSION['CIF']);
