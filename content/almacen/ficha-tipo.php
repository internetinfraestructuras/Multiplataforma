...
('PRODUCTOS_TIPOS,PROVEEDORES',
    array("PRODUCTOS_TIPOS.id","PRODUCTOS_TIPOS.nombre","productos_tipos.id_proveedor"),"proveedores.id=productos_tipos.id_proveedor","PRODUCTOS_TIPOS.nombre");

$id=$listado[0][0];
$nombre=$listado[0][1];
$idProveedor=$listado[0][2];
