...
define('ID_ORDEN_ASIGNADA',2);
define('ID_ORDEN_TRAMITE',3);
define('ID_ORDEN_CERRADA',4);
define('ID_ORDEN_INCIDENCIA',5);
define('ID_ORDEN_CANCELADA',6);
define('ID_ORDEN_FACTURADA',7);
define('ID_ORDEN_COBRADA_CAJA',8);
define('ID_ORDEN_COBRADA_TECNICO',9);
define('ID_ORDEN_COBRADA_BANCO',10);
define('ID_ORDEN_DEVUELTO',11);
define('ID_ORDEN_PTE_COBRO',12);


/*ESTADOS FACTURAS*/
define('ID_FACTURA_GENERADA',1);
define('ID_FACTURA_ANULADA',2);
define('ID_FACTURA_IMPAGADA',3);
define('ID_FACTURA_PAGADA',4);
