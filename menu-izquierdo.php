...
<nav id="sideNav"><!-- MAIN MENU -->
    <ul class="nav nav-list">
        ...
        <li>
            ...
            <ul><!-- submenus -->
                <li><a href="/m3/content/trabajos/ordenes-hoy.php">Ordenes de hoy</a></li>
                <li><a href="/m3/content/trabajos/ordenes.php">Ordenes de trabajo</a></li>
        ...
        <li>
            <a href="#">
                <i class="fa fa-menu-arrow pull-right"></i>
                <i class="main-icon fa fa-support"></i> <span><?php echo MNU_ITEM_12; ?></span>
            </a>
            <ul><!-- submenus -->
                <li><a href="<?php echo $root;?>/m3/content/configuracion/configuracion-contratos.php">Contratos</a></li>
